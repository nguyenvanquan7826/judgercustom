		...
		<table class="standings" style="font-size: medium;">
			<tr style="background-color: #EDEDEE; line-height: 20px">
          	...
          	foreach ($rank as $r) : $i++;
                ...
                $time = $me ?  $r['final']['last'] : $r[$keyStaust]['last'];
                $time -= $begintime;
                $time = (int) ($time / 60) + 1;
                $time = $time > 0 ? $time : 0;
                ?>
          		...
          		<tr style="line-height: 20px">
          			...
          			<td class="<?php echo $color ?>"><strong><?php echo $total ?></strong></td>
                    <td class="<?php echo $color ?>"><strong><?php echo $time ?></strong></td>
                    ...
                    ?>
	                    <td class="contestant-cell <?php echo $color . ' ' . $classPending?>" style="color: #5cb85c"><strong><?php echo $score ?></strong></td>
	                <?php endforeach ?> 
          		</tr>
          	<?php endforeach; ?>
      	</table>
